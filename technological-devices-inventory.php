    ...
    <div class="list-section" id="item-list-container">
      ...
      <?php
        ...
        if (!empty($_GET['search'])) {
          ...
          $sql .= " WHERE equipment_id LIKE '%$searchTerm%' OR equipment_type LIKE '%$searchTerm%' OR product_model LIKE '%$searchTerm%' OR supplier LIKE '%$searchTerm%' OR serial_number LIKE '%$searchTerm%' OR end_user LIKE '%$searchTerm%'";
        }
